...
function modal (triggerSelector, modalSelector, modalTimerId) {
    ...
    const targetModalBtn = document.querySelectorAll(triggerSelector);
    const modal = document.querySelector(modalSelector);
...
function tabs (tabsSelector, tabsContentSelector, tabsParentsSelector, activeClass) {
    ...
    const tabsParent = document.querySelector(tabsParentsSelector);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2023-05-11'); 
});
